...
ТРЕБОВАНИЯ К ОТКРЫТЫМ ЗАДАНИЯМ (open_question, matching, fill_blank) — БАЗОВЫЙ:
Открытые задания должны быть простыми, НО содержательными:
- open_question: прямое применение правила/формулы, но ответ требует записи решения или объяснения, а не только числа
- matching: очевидные пары, но элементов достаточно (4-5 пар), чтобы задание не было тривиальным
- fill_blank: простые конструкции, но пропуски на ключевые термины/значения, требующие понимания
...
ТРЕБОВАНИЯ К ОТКРЫТЫМ ЗАДАНИЯМ (open_question, matching, fill_blank) — СРЕДНИЙ:
Открытые задания должны быть СЛОЖНЕЕ простого воспроизведения:
- open_question: 2-3 шага решения, требуют промежуточных рассуждений и объяснения хода решения; ответ — не одно число, а развёрнутое решение
- matching: неочевидные связи, требующие понимания темы; элементы не должны быть простыми синонимами
- fill_blank: пропуски на ключевые этапы рассуждения, а не на отдельные слова; конструкции с 3+ пропусками
...
ТРЕБОВАНИЯ К ОТКРЫТЫМ ЗАДАНИЯМ (open_question, matching, fill_blank) — ПОВЫШЕННЫЙ:
Открытые задания ДОЛЖНЫ быть СЛОЖНЕЕ тестовых заданий того же уровня:
- open_question: многошаговое решение (3-5 шагов), комбинирование тем, нестандартные формулировки; развёрнутый ответ с обоснованием
- matching: неочевидные пары, требующие глубокого анализа; элементы из разных подтем, связи неявные
- fill_blank: сложные конструкции с 4+ пропусками, где заполнение одного зависит от понимания другого; цепочки рассуждений
Тестовые задания ограничены выбором из вариантов — открытые задания этого ограничения не имеют, поэтому их сложность ОБЯЗАНА быть выше!
...
⚠️ ОБЯЗАТЕЛЬНО учти эти пожелания при составлении заданий. Пожелания могут влиять на язык заданий, стиль формулировок, контекст примеров и другие аспекты. Пожелания НЕ меняют тему — тема указана выше.
  `.trim()
}
