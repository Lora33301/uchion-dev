...
- Элементы правого столбца ОБЯЗАТЕЛЬНО должны быть перемешаны — порядок правого столбца НЕ ДОЛЖЕН совпадать с порядком левого
- НЕ включай в instruction ответы, подсказки или указания на правильные пары (типа "1→а", "Ответ: ...")
- НЕ добавляй нумерацию (1., 2.) или буквы (а., б.) в сами элементы столбцов — нумерация добавляется автоматически при отображении
- Элементы столбцов должны содержать ТОЛЬКО контент задания, без маркеров ответа`,
  example: {
