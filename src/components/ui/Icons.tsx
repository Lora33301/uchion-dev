// Shared icon components — Heroicons-based SVGs used across the app.
// All icons accept optional className prop for sizing/styling.
...
export function DocumentPlusIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export function FolderIcon({ className = "w-5 h-5", color }: FolderIconProps) {
  return (
...
export function FolderMoveIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
