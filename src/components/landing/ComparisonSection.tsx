const BLOCKS = [
  ...
  },
  {
    ...
    manual: { time: 'Ограничения', items: ['1-2 варианта для всех', 'Сложно подстроить под уровень', 'Нет выбора оформления'] },
  ...
  },
  {
    ...
    manual: { time: 'Долго', items: ['Форматирование под печать', 'Ч/б или цвет — отдельная работа'] },
