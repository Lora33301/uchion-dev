...
export const users = pgTable('users', {
  ...
  referralCode: varchar('referral_code', { length: 16 }).unique(), // Generated by admin only; null = not an ambassador
  referredBy: uuid('referred_by'), // FK to users.id; the ambassador who invited this user
  referredAt: timestamp('referred_at', { withTimezone: true }), // When the referral was captured (registration time)
  referredIp: varchar('referred_ip', { length: 64 }), // Client IP at registration, for fraud review
  referredEmailNorm: varchar('referred_email_norm', { length: 255 }), // Normalized email at registration, for fraud review
